...
import com.example.newsfeed.databinding.FragmentBusinessfragmentBinding
import com.example.newsfeed.databinding.FragmentHomefragmentBinding
import kotlinx.android.synthetic.main.fragment_businessfragment.*
 ...
 */
class Businessfragment : Fragment(),NewsClicked {
    ...
    override fun onCreateView(
        ...
        binding= FragmentBusinessfragmentBinding.inflate(layoutInflater)
    ...
    private fun fetch(){
        val url ="https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=8a27a8c795af41d0b27dbfcc79bf65c6"
