 ...
 */
class Sportsfragment : Fragment(),NewsClicked {
    ...
    private fun fetch(){
        //val con:String="us"
        val url ="https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=8a27a8c795af41d0b27dbfcc79bf65c6"
